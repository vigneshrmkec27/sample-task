...
const Login = ({ onLoginSuccess, onSwitchToRegister, darkMode, showNotification }) => {
    ...
    return (
        <div className="min-h-screen flex overflow-hidden auth-shell">
            ...
            <div className="hidden lg:flex w-[60%] relative items-center justify-center bg-[#F5FBF7] dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 overflow-hidden auth-visual">

                {/* Animated gradient blobs */}
                <div className="absolute w-[500px] h-[500px] bg-emerald-300/40 rounded-full blur-[120px] top-[-120px] left-[-120px] animate-pulse float-ambient" />
                <div className="absolute w-[420px] h-[420px] bg-lime-300/40 rounded-full blur-[120px] bottom-[-120px] right-[-120px] animate-pulse float-ambient delay-1000" />
                <div className="absolute w-[300px] h-[300px] bg-green-300/40 rounded-full blur-[100px] top-1/3 right-1/4 animate-pulse float-ambient delay-500" />
